 ...
 */
//******************************************************************************
//マウスのドラッグで視点移動を行うCanvas3D拡張クラス“ViewChangeCanvas3D”
//
//Canvas3Dを継承
...
public class ViewChangeCanvas3D extends Canvas3D
{
    ...
    //マウスの動きに対する感度
    float sensitivity;
    static final float sensitivity_default = 0.01f;

    //動径の長さ（座標中心と視点との距離）
    float camera_distance;
    static final float camera_distance_default = 0.0f;
    ...
    //=============================================================================
    //コンストラクタ
    public ViewChangeCanvas3D(GraphicsConfiguration config, float Distance)
    {
    ...
    public ViewChangeCanvas3D(GraphicsConfiguration config, float Distance) {
        this(config, Distance, sensitivity_default);
    }
